...
# load
nii = load('/home/faruk/gdrive/Segmentator/data/faruk/arcweld/S02_T1wDivPD_bet_nosub_aniso.nii.gz')
ima = nii.get_data()
...
# insert zero-max arc
zmax_center = (0 + ima_max) / 2
zmax_radius = ima_max - zmax_center
...
soft[-1, :] = np.abs(soft[-1, :] - zmax_radius)

zmax_weight = (gra / zmax_radius)**-1
# zmax_weight = (((gra / zmax_radius) + (ima / tissues[-1])) / 2)**-1
soft[-1, :] = zmax_weight*soft[-1, :]
